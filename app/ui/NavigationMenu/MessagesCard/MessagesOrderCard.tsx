...
const MessagesOrderCard = () => {
  ...
  return (
    <div className="w-full h-[calc(90vh-52px)]">
      ...
      <div className="text-gray-400 w-full h-[calc(100%-47px)] flex flex-col items-center justify-center gap-4">
        <BsBoxSeam size={90} />
        <p>No logistics information</p>
      </div>
    </div>
  );
};

export default MessagesOrderCard;

...
const CouponsPage = () => {
  ...
  const tabContent = {
    unused: "You don't have any coupons or offers available",
    used: "You don't have any used coupons or offers. Only coupons that were used in the last 3 months are shown on this list.",
    expired:
      "You don't have any expired coupons or offers. Only coupons that were expired within 3 months are shown on this list.",
  };
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      {activeTab === "unused" && (
        <div className="space-y-4">
          <div className="flex space-x-2 w-fit">
            ...
            />
            <button className="bg-white text-black border border-gray-700 rounded-full px-4 py-2">
              Apply
            </button>
          </div>
      ...
      <div className="space-y-3">
        ...
        <div className="flex space-x-3 text-sm">
          <button className="border border-orange-500 flex flex-1 items-center justify-between gap-2 px-3 py-1 rounded w-full">
          ...
          <button
            className="border border-orange-500 flex-1 px-3 py-1 

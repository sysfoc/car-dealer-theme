...
export const products: Product[] = [
  ...
  },
  {
    id: 8,
    description:
      "An efficient cleaner brush designed to quickly and thoroughly clean makeup brushes...",
    price: 349,
    sold: 5600,
    image: "/videos/cleanerBrush.mp4",
  ...
  },
  {
    id: 11,
    description:
      "Elegant and versatile earrings crafted to enhance your style...",
    price: 799,
    sold: 1200,
    image: "/videos/earRing.mp4",
  ...
  },
  {
    id: 13,
    description:
      "Precision-engineered Gillette blade for a smooth, comfortable...",
    price: 499,
    sold: 1800,
    image: "/videos/gilletteBlade.mp4",
    tags: [
      "SUMMER ESSENTIAL",
      "#2 HOME APPLIANCE",
      "ENERGY SAVER",
  ...
  {
    id: 15,
    description: "A complete hair remover kit designed for smooth...",
    price: 499,
    sold: 1300,
    image: "/videos/hairRemoverKit.mp4",
  ...
  },
  {
    id: 16,
    description:
      "Comfortable and durable jogger shoes designed for all-day wear...",
    price: 499,
    sold: 4200,
    image: "/videos/JoggerShoes.mp4",
    tags: [
      "#1 CREATIVE TOOL",
      "ARTIST FAVORITE",
      "EDUCATION DISCOUNT",
  ...
  },
  {
    id: 18,
    description:
      "A compact and efficient lint remover that quickly removes fuzz, lint, and pet hair from clothes and fabrics.",
    price: 2599,
    sold: 900,
    ...
    category: "Home Appliances",
    offerEndTime: "2025-03-01T23:59:59Z",
  },
  {
    id: 19,
    description:
      "A high-definition security camera designed to provide reliable surveillance and peace of mind for your home or business.",
    price: 199,
    sold: 3000,
  ...
  },
  {
    id: 20,
    description:
      "A premium luxury watch that combines exquisite craftsmanship with timeless design, perfect for any occasion.",
    price: 129,
    sold: 9500,
  ...
  },
  {
    id: 21,
    description:
      " A durable and precise mechanical plastic tool designed for high-performance applications and long-lasting use.",
    price: 59,
    sold: 8000,
  ...
  },
  {
    id: 22,
    description:
      "A stylish and functional ladies' bag, perfect for carrying essentials while adding a chic touch to any outfit.",
    price: 199,
    sold: 3200,
  ...
  },
  {
    id: 23,
    description:
      "A nose hair trimmer designed for quick, painless, and safe trimming of unwanted nose hair.",
    price: 599,
    sold: 1500,
  ...
  },
  {
    id: 25,
    description:
      "A versatile scissor and comb kit designed for precise hair cutting and styling, perfect for professional or home use.",
    price: 99,
    sold: 4500,
    image: "/videos/ScissoreCombKit.mp4",
  ...
  },
  {
    id: 26,
    description:
      "A high-quality speaker system delivering clear, powerful sound for an immersive audio experience.",
    price: 399,
    sold: 3200,
    image: "/videos/speakerSystem.mp4",
    tags: [
      "#1 OUTDOOR GEAR",
      "ADVENTURE READY",
      "YOUTUBER'S PICK",
  ...
  },
  {
    id: 27,
    description:
      "Comfortable and durable sporty shoes designed for active lifestyles, offering support and performance for various sports and workouts.",
    price: 1899,
    sold: 2300,
    image: "/videos/SportyShoes.mp4",
    tags: [
      "#2 PREMIUM PICK",
      "CREATOR EDITION",
      "BACK IN STOCK",
    ...
    category: "Footwear",
    offerEndTime: "2025-03-15T23:59:59Z",
  },
  {
    id: 28,
    description:
      "Soft and absorbent towel perfect for drying off after a shower or bath, providing comfort and durability.",
    price: 299,
    sold: 2900,
    image: "/videos/towel.mp4",
    tags: [
      "#3 NETWORKING",
      "GAMING OPTIMIZED",
      "PARENTAL CONTROLS",
    ...
    offerEndTime: "2025-03-20T23:59:59Z",
  },
  {
    id: 29,
    description:
      "A sleek and easy-to-read digital clock that displays the time with precision and style.",
    price: 89,
    sold: 4500,
    ...
    category: "Home Essentials",
    offerEndTime: "2025-03-25T23:59:59Z",
  },
  {
    id: 30,
    description:
      "A portable Bluetooth speaker with 360° sound quality, offering immersive audio and effortless connectivity for any setting.",
    price: 159,
    sold: 6800,
    image: "/images/productPicture.jpg",
    ...
    category: "Electronics",
    offerEndTime: "2025-03-30T23:59:59Z",
  },
];
